...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        '''
        this function trains the model does hyperparameter tuning does evaluation and return modelTrainerArtifact'''
        models = {
        ...
        '''
        MLflow helps you organize, track, and deploy your machine learning experiments and models efficiently.
        '''
